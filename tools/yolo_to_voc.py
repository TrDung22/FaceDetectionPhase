"""
This code is used to convert annotations from YOLO format to VOC format
"""
...
## path root folder
ROOT = '/home/trdung/Documents/BoschPrj/00_EDABK_Face_labels/VOCFormat'


## converts coco into xml 
def xmlTransform(root):
    class_path  = join(root, 'textFolder')
    ids = list()
    ...
    annopath = join(root, 'textFolder', '%s.txt')
    imgpath = join(root, 'JPEGImages', '%s.jpg')
